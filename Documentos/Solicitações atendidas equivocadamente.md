INSTRUÇÕES PRA USO DESSAS INFORMAÇÕES ABAIXO:

Aqui consta solicitações de mudanças nos cards dos equipamentos, onde muitos links e dados da ficha técnicas não foam atendidas corretamente, então fiz um levantamento manual e entreguei ao antigravity, mas infelizmente houve colapso do trabalho e perda total. mas aqui consta algumas mudanças que foram solicitadas.
